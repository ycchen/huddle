...
class StatusReportsControllerTest < ActionController::TestCase
  ...
  test "should create status_report" do
    assert_difference('StatusReport.count') do
      post :create, status_report: { invoke: @status_report.invoke, rspec: @status_report.rspec, status_date: @status_report.status_date, today: @status_report.today, yesterday: @status_report.yesterday }
    end
  ...
  test "should update status_report" do
    put :update, id: @status_report, status_report: { invoke: @status_report.invoke, rspec: @status_report.rspec, status_date: @status_report.status_date, today: @status_report.today, yesterday: @status_report.yesterday }
    assert_redirected_to status_report_path(assigns(:status_report))
  end
